...
def superellipse(a=1,b=1,m=1,n=1001,draw=True):
    ...
    x = a*np.abs(sin_vals)**(2/m)*np.sign(sin_vals)
    y = b*np.abs(cos_vals)**(2/m)*np.sign(cos_vals)
...
def superellipse_mod(a=1,b=1,m1=1,m2=1,n=1001,draw=True):
