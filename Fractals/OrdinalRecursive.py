...
if __name__ == '__main__':
    ...
    print("This can be done without reference to the idea of 'the ordinals before it' simply by defining a successor function that builds the next ordinal as the union of itself with the set that contains it.")
